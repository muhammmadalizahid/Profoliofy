    ...
    <div className="group relative">
      ...
      <div className="relative">
        {multiline ? (
          <textarea
            name={field}
            className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg transition-all duration-300 resize-none h-24 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            value={form[field] || ''}
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            value={form[field] || ''}
            onChange={(e) => handleChange(field, e.target.value)}
            placeholder={placeholder}
            required={required}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="text-center">
              <button
                type="submit"
                className="inline-flex items-center gap-3 px-8 py-4 bg-blue-900 hover:bg-blue-700 text-white font-bold rounded-xl transition-colors"
              >
